# Script for experiment 22
# Script to uses T, OHC and CO2 MAEs WITHOUT accounting for T, OHC unc
...
OUTPUT <- file.path(RESULTS_DIR, "22_alpha_ecs_ohc_mae.txt")
