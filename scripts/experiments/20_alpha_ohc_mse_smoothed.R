# Script for experiment 20
# Script to use T, OHC and CO2 MSEs without accounting for uncertainty
...
OUTPUT <- file.path(RESULTS_DIR, "20_alpha_ecs_ohc_unc_mse_smoothed.txt")
...
optim_data <- rbind(co2_data, smoothed_temp_data, ohc_data)

### Calling optim ###
best_pars <- run_optim(obs_data = optim_data,
                       ini_file = INI_FILE,
                       params = PARAMS,
...
write_metric("OHC MSE:", OHC_mse, OUTPUT)
